const projects: Project[] = [
	{
		...
		description:
			'Burrito sabanero is a multipurpose bot that will help your server users to have fun.',
	...
	},
	{
		...
		name: 'Fietu',
		description:
			'Fietu is a Node.js module that facilitates the generation of images using Canvas and Jimp.',
		img: '/fietu.png',
